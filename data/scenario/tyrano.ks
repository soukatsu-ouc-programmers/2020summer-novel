...
[macro name="cg_image_button"]
	...
	[if exp="tf.is_cg_open==true"]
		[button name="cg_image_area" graphic=&mp.tmp_graphic[0] x=&mp.x y=&mp.y width=&mp.width height=&mp.height preexp="mp.graphic" exp="tf.selected_cg_image = preexp" storage="cg.ks" target="*clickcg" folder=&mp.folder ]
	[else]
		[button name="cg_image_area" graphic=&mp.no_graphic x=&mp.x y=&mp.y width=&mp.width height=&mp.height storage="cg.ks" target="*no_image" folder="bgimage" ]
	[endif]
[endmacro]
