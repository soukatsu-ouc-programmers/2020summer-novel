...
;	メニューボタン非表示
	...
	tf.btn_path_on  = tf.img_path + 'c_set2.png';
...
;	画面右上の「Back」ボタン
	[button fix="true" graphic="&tf.img_path + 'menu_button_close.png'" enterimg="&tf.img_path + 'menu_button_close2.png'" target="*backtitle" x="1160" y="20"]
...
;------------------------------------------------------------------------------------------------------
	...
	$(".bgmvol_"+tf.current_bgm_vol).attr("src","data/image/config/c_set2.png");

	$(".sevol_"+tf.current_se_vol).attr("src","data/image/config/c_set2.png");

	$(".ch_"+tf.current_ch_speed).attr("src","data/image/config/c_set2.png");

	$(".auto_"+tf.current_auto_speed).attr("src","data/image/config/c_set2.png");

	if(tf.text_skip == 'OFF'){
		$(".unread_off").attr("src","./data/image/config/c_skipoff2.png");
		}else{
			$(".unread_on").attr("src","./data/image/config/c_skipon2.png");
			}
	[endscript]
...
*ch_speed_change
	...
	$(".ch_"+tf.set_ch_speed).attr("src","data/image/config/c_set2.png");
...
*auto_speed_change
	...
	$(".auto_"+tf.set_auto_speed).attr("src","data/image/config/c_set2.png");
